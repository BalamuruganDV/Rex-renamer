...
async def show_settings(m: "types.Message"):
    ...
    if not user_data:
        await m.edit("Failed to fetch your data from database!.Contact @REX_Bots_Support")
        return
    ...
    buttons_markup = [
        [types.InlineKeyboardButton(f"ᴜᴘʟᴏᴀᴅ ᴀs ᴅᴏᴄ {'✅' if upload_as_doc else '❌'}",
                                    callback_data="triggerUploadMode")],
        [types.InlineKeyboardButton(f"ᴀᴘᴘʟʏ ᴄᴀᴘᴛɪᴏɴ {'✅' if apply_caption else '❌'}",
                                    callback_data="triggerApplyCaption")],
        [types.InlineKeyboardButton(f"ᴀᴘᴘʟʏ ᴅᴇғᴀᴜʟᴛ ᴄᴀᴘᴛɪᴏɴ {'❌' if caption else '✅'}",
                                    callback_data="triggerApplyDefaultCaption")],
        [types.InlineKeyboardButton("sᴇᴛ ᴄᴜsᴛᴏᴍ ᴄᴀᴘᴛɪᴏɴ",
    ...
    if caption:
        buttons_markup.append([types.InlineKeyboardButton("sʜᴏᴡ ᴄᴀᴘᴛɪᴏɴ",
                                                          callback_data="showCaption")])
    buttons_markup.append([types.InlineKeyboardButton("ᴄʟᴏsᴇ ᴍᴇssᴀɢᴇ",
